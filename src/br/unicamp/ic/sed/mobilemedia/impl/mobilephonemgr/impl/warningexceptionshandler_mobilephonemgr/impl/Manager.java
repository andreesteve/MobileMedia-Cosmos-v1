...
import br.unicamp.ic.sed.mobilemedia.impl.mobilephonemgr.impl.warningexceptionshandler_mobilephonemgr.impl.IExceptionsHandlerAdapter;
...
class Manager extends AManager implements IManager{
	...
	public Manager() { //System.out.println("Manager.Manager()");
		...
		setRequiredInterfaceType("IExceptionsHandlerCtr", IExceptionsHandlerCtr.class);
	}
