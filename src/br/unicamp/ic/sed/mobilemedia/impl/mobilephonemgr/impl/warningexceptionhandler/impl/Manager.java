...
import br.unicamp.ic.sed.mobilemedia.impl.mobilephonemgr.impl.warningexceptionhandler.impl.IExceptionHandlerFacade;
...
class Manager extends AManager implements IManager{
	...
	public Manager() { //System.out.println("Manager.Manager()");
		...
		setRequiredInterfaceType("IMobileResources", IMobileResourcesWEH.class);		
	}
